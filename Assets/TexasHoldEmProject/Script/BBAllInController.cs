...
#region allInFunctions
        ...
        public bool checkIfCanAllInForAIPlayers(
            int playerID,
            float currentPlayerTotalMoney,
            float allInInActionValue
        )
        {
            ...
            {
                Debug.Log(
                    "--- 2 --- executeAIOnFinishTurnAction xxxxxxxxxxxxxxxxxxxxxx allInInAction xxxxxxxxxxxxxxxxxxxxxx player : "
                        + playerID
                        + " playerMoney : "
                        + currentPlayerTotalMoney
                        + " allIn Value : "
                        + allInInActionValue
                        + " toCall : "
                        + toCall
        ...
        public IEnumerator executeAllInCallForAIPlayer(int playerID)
        {
            ...
            Debug.Log(
                "executeAllInCallForAIPlayer xxxxxxxxxxxxxxxxxxxxxx executeAllInCallForAIPlayer xxxxxxxxxxxxxxxxxxxxxx player : "
                    + playerID
                    + " raiseBetVal : "
                    + raiseBetVal
            );
            ...
            yield return StartCoroutine(
                GetComponent<BBMoveingObjectsController>()
                    .moveChip(
                        raiseBetVal,
                        playerID,
                        GetComponent<BBMoveingObjectsController>().PlayersChipRaiseBetPosition[
                            playerID
                        ]
                    )
            );
        ...
        {
            yield return StartCoroutine(
                GetComponent<BBShowDownResultController>().rotateCoveredCards()
            );
            ...
            for (int x = 0; x < playersCVal.Count; x++)
            {
                ...
                Image AvatarImage =
                    GetComponent<BBShowDownResultController>().playerFinalResultUIList[x].transform
                        .Find("ImageAvatar")
                        .GetComponent<Image>();
                ...
                if (playersCVal[x].isRoundOut || BBGC.playerDataList[x].isOutOfGame)
                {
                    ...
                    Image wonLoseImage =
                        GetComponent<BBShowDownResultController>().playerFinalResultUIList[
                            x
                        ].transform
                            .Find("ImageWonLose")
                            .GetComponent<Image>();
                ...
                else
                {
                    ...
                    else
                    {
                        GetComponent<BBShowDownResultController>().playerFinalResultUIList[
                            ...
                            .Find("TextResult")
                            .GetComponent<Text>().text = GetComponent<BBShowDownResultController>()
                            .getFormattedBestFive(playersCVal[x].bestFive);
                        GetComponent<BBShowDownResultController>().playerFinalResultUIList[
                            x
                        ].transform
                            .Find("TextBestFive")
                ...
                if (playersCVal[x].kickerOnPlayerCard[0] != 0)
                {
                    GetComponent<BBShowDownResultController>().playerFinalResultUIList[x].transform
                        .Find("TextBestKicker")
                        .GetComponent<Text>().text = GetComponent<BBShowDownResultController>()
                        .getFormattedValue(playersCVal[x].kickerOnPlayerCard[0]);
                }
            }
            ...
            else
            {
                ...
                )
                {
                    ...
                    if (bng != null)
                        bng.gameObject.SetActive(false);
                }
                else
                {
                    GetComponent<BBShowDownResultController>().finalResultPanel.SetActive(true);
        ...
        {
            Debug.Log(
                "................................................... *** executeShowDowmAllin *** ...........executePlayerWoneCoseAlone..............................foldOut : "
                    + foldOutPlayers
                    + " runOut : "
                    + runOutPlayers
                    + " phase : "
        ...
        public void executeShowDowmAllin()
        {
            ...
            Debug.Log(
                "................................................... *** executeShowDowmAllin *** ......................................... foldOutPlayers : "
                    + foldOutPlayers
                    + " runOutPlayers : "
                    + runOutPlayers
            );
            ...
            Debug.Log(
                "[BBAllInController][executeShowDowmAllin] onlyOpenCardsValue =============>> : "
                    + onlyOpenCardsValue
                    + " : "
                    + maxCardVal
            );
        ...
        )
        {
            ...
            {
                if (
                    GetComponent<BBGameController>()._BBGlobalDefinitions.gamePhaseDetail
                        == BBGlobalDefinitions.GamePhaseDetail.ShowDownAllInOnFlop
                    || GetComponent<BBGameController>()._BBGlobalDefinitions.gamePhaseDetail
                        == BBGlobalDefinitions.GamePhaseDetail.Flop
                )
                {
                    ...
                    GetComponent<BBGameController>()._BBGlobalDefinitions.gamePhaseDetail
                        == BBGlobalDefinitions.GamePhaseDetail.ShowDownAllInOnTurn
                    || GetComponent<BBGameController>()._BBGlobalDefinitions.gamePhaseDetail
                        == BBGlobalDefinitions.GamePhaseDetail.Turn
                )
                {
                    ...
                    GetComponent<BBGameController>()._BBGlobalDefinitions.gamePhaseDetail
                        == BBGlobalDefinitions.GamePhaseDetail.ShowDownAllInOnRiver
                    || GetComponent<BBGameController>()._BBGlobalDefinitions.gamePhaseDetail
                        == BBGlobalDefinitions.GamePhaseDetail.River
                )
                {
...
*/
        ...
        List<Vector4> getFinalResultForTwoPair(Vector4[] tmpRes)
        {
            ...
            foreach (Vector4 v in BBresBest)
                Debug.Log(v);
            Debug.Log("============BBresBest=======================");
