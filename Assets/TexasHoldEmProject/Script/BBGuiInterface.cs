    ...
    public class BBGuiInterface : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (_BBGameController._BBGlobalDefinitions.isAnOpenGame)
                ImageGameGeneralPhase.color = Color.green;
            else
                ImageGameGeneralPhase.color = Color.red;
        ...
        void Start()
        {
            ...
            TextGameSTACK.text =
                "Stack : " + BBStaticData.getMoneyValue(BBStaticData.gameLimitedStackValue);
        ...
        public void setPlayersData(List<BBPlayerData> pDataList)
        {
            ...
            {
                Text TextPlayerName = m_PlayersDataList[x].transform
                    .Find("TextPlayerName")
                    .GetComponent<Text>();
                pDataList[x].T_playerName = TextPlayerName;
                pDataList[x].T_playerName.text = _BBGameController._BBGlobalDefinitions.playersName[
                    x
                ]; //pDataList[x].playerName;

                Text TextPlayerBetType = m_PlayersDataList[x].transform
                    .Find("TextPlayerBetType")
                    .GetComponent<Text>();
                pDataList[x].T_TextPlayerBetType = TextPlayerBetType;
                pDataList[x].T_TextPlayerBetType.text = "";

                Text TextPlayerMoneyOnTable = m_PlayersDataList[x].transform
                    .Find("TextPlayerMoneyOnTable")
                    .GetComponent<Text>();
                pDataList[x].T_PlayerMoneyOnTable = TextPlayerMoneyOnTable;
                pDataList[x].T_PlayerMoneyOnTable.text = "";

                Text TextPlayerMoneyTotal = m_PlayersDataList[x].transform
                    .Find("TextPlayerMoneyTotal")
                    .GetComponent<Text>();
                ...
                switch (_BBGameController._BBGlobalDefinitions.gameType)
                {
                    case BBGlobalDefinitions.GameType.Limited:
                        pDataList[x].T_PlayerMoneyTotal.text = BBStaticData.getMoneyValue(
                            _BBGameController._BBGlobalDefinitions.playersCashDuringOpenGame[x]
                        );
                        pDataList[x].currentPlayerTotalMoney =
                            _BBGameController._BBGlobalDefinitions.playersCashDuringOpenGame[x];
                        break;
                ...
                Image PlayerActiveImage = m_PlayersDataList[x].transform
                    .Find("PlayerActiveImage")
                    .GetComponent<Image>();
                ...
                Image AvatarImage = m_PlayersDataList[x].transform
                    .Find("AvatarImage")
                    .GetComponent<Image>();
                pDataList[x].playerAvatarImage = AvatarImage;
                pDataList[x].playerAvatarImage.overrideSprite = sprite;

                GameObject PlayerDealerImage =
                    m_PlayersDataList[x].transform.Find("PlayerDealerImage").gameObject;
                ...
                SpotlightOnPlayersList[x] =
                    m_PlayersDataList[x].transform.Find("Spotlight").gameObject;
        ...
        public void activateDealer()
        {
            if (
                (
                    PlayerActiveImageList[
                        _BBGameController._BBGlobalDefinitions.currentActivedealer
                    ].color == Color.black
                )
                || (
                    PlayerActiveImageList[
            ...
            {
                BBStaticData.setAllPlayersStateImgRed(
                    PlayerActiveImageList,
                    "BBGuiInterface/activateDealer"
                );
            ...
            foreach (GameObject i in SpotlightOnPlayersList)
            {
                i.SetActive(false);
            }
            if (
        ...
        public void setGreenOnPlayer(int playerID)
        {
            BBStaticData.setAllPlayersStateImgRed(
                PlayerActiveImageList,
                "BBGuiInterface/setGreenOnPlayer PId : " + playerID
            );
        ...
        public void activatePlayer()
        {
            ...
            {
                PlayerActiveImageList[
                    _BBGameController._BBGlobalDefinitions.currentActivePlayer
                ].color = Color.green;
            }
        ...
        {
            float onTableVal = _BBGameController.playerDataList[
                _BBGameController._BBGlobalDefinitions.currentActivePlayer
            ].currentMoneyOnTable += val;
            float totalVal = _BBGameController.playerDataList[
                _BBGameController._BBGlobalDefinitions.currentActivePlayer
            ].currentPlayerTotalMoney -= val;

            _BBGameController.playerDataList[
                _BBGameController._BBGlobalDefinitions.currentActivePlayer
            ].T_PlayerMoneyOnTable.text = BBStaticData.getMoneyValue(onTableVal);
            _BBGameController.playerDataList[
                _BBGameController._BBGlobalDefinitions.currentActivePlayer
            ].T_PlayerMoneyTotal.text = BBStaticData.getMoneyValue(totalVal);
        ...
        {
            float onTableVal = _BBGameController.playerDataList[playerID].currentMoneyOnTable +=
                val;
            float totalVal = _BBGameController.playerDataList[playerID].currentPlayerTotalMoney -=
                val;

            _BBGameController.playerDataList[playerID].T_PlayerMoneyOnTable.text =
                BBStaticData.getMoneyValue(onTableVal);
            _BBGameController.playerDataList[playerID].T_PlayerMoneyTotal.text =
                BBStaticData.getMoneyValue(totalVal);
        ...
        public void setDealer()
        {
            _BBGameController.playerDataList[
                _BBGameController._BBGlobalDefinitions.currentActivedealer
            ].PlayerDealerImage.SetActive(true);
        }

        public void activatePlayerToTalk()
        {
            if (_BBGameController._BBGlobalDefinitions.playerToTalk == 10)
                _BBGameController._BBGlobalDefinitions.playerToTalk = 0;

            Debug.Log(
                "[BBGuiInterface][setPlayerMoneyValue] playerToTalk : "
                    + (_BBGameController._BBGlobalDefinitions.playerToTalk)
                    + " : "
                    + _BBGameController._BBGlobalDefinitions.localPlayer
            );

            BBStaticData.setAllPlayersStateImgRed(
                PlayerActiveImageList,
                "BBGuiInterface/activatePlayerToTalk"
            );
            ...
            {
                PlayerActiveImageList[_BBGameController._BBGlobalDefinitions.playerToTalk].color =
                    Color.green;
            }
        ...
        public void activatePlayerToTalk(int playerID)
        {
            ...
            BBStaticData.setAllPlayersStateImgRed(
                PlayerActiveImageList,
                "BBGuiInterface/activatePlayerToTalk playerId : " + playerID
            );
            ...
            if (
                ...
                || (
                    _BBGameController._BBGlobalDefinitions.playersStateIsOutDuringOpenGame[
                        _BBGameController._BBGlobalDefinitions.playerToTalk
                    ] == true
                )
            ) { }
            else
            {
                PlayerActiveImageList[_BBGameController._BBGlobalDefinitions.playerToTalk].color =
                    Color.green;
                Debug.Log(
                    ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>[BBGuiInterface][activatePlayerToTalk] playerToTalk  Color.green"
                );
            }
...
*/
            ...
            buttonGameCALL.interactable = call;
            buttonGameCALL.GetComponent<Image>().enabled = call;
            buttonGameCALL.GetComponentInChildren<Text>().enabled = call;
            buttonGameFOLD.interactable = fold;
            buttonGameFOLD.GetComponent<Image>().enabled = fold;
            buttonGameFOLD.GetComponentInChildren<Text>().enabled = fold;
            buttonGameRAISE.interactable = raise;
            buttonGameRAISE.GetComponent<Image>().enabled = raise;
            buttonGameRAISE.GetComponentInChildren<Text>().enabled = raise;

            if (
                _BBGameController._BBGlobalDefinitions.gameType
                == BBGlobalDefinitions.GameType.Limited
            )
            {
                allin = false;
        ...
        {
            Image[] imList = GameActionButtonsRoot.GetComponentsInChildren<Image>(true);
            foreach (Image i in imList)
                i.enabled = wantShow;
            Text[] txList = GameActionButtonsRoot.GetComponentsInChildren<Text>(true);
            foreach (Text t in txList)
                t.enabled = wantShow;
            ...
            if (wantShow)
            {
                ...
                GameActionButtonsRoot
                    .Find("ImageCardsContainer/ImageCARD_1")
                    .GetComponent<RawImage>().texture = card1;
                GameActionButtonsRoot
                    .Find("ImageCardsContainer/ImageCARD_2")
                    .GetComponent<RawImage>().texture = card2;

                if (_BBGameController.flopCardList[0] == Vector2.zero)
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_1")
                ...
                else
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_1")
                        .GetComponent<RawImage>().texture = getCardImage(
                        _BBGameController.flopCardList[0]
                    );
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_1")
                ...
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_2")
                        .GetComponent<RawImage>().enabled = false;
                }
                else
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_2")
                        .GetComponent<RawImage>().texture = getCardImage(
                        _BBGameController.flopCardList[1]
                    );
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_2")
                        .GetComponent<RawImage>().enabled = true;
                ...
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_3")
                        .GetComponent<RawImage>().enabled = false;
                }
                else
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_3")
                        .GetComponent<RawImage>().texture = getCardImage(
                        _BBGameController.flopCardList[2]
                    );
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_FLOP_3")
                        .GetComponent<RawImage>().enabled = true;
                ...
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_TURN")
                        .GetComponent<RawImage>().enabled = false;
                }
                else
                {
                ...
                {
                    GameActionButtonsRoot
                        .Find("ImageCardsContainer/ImageCARD_RIVER")
                        .GetComponent<RawImage>().enabled = false;
                }
                else
                {
                ...
                switch (_BBGameController._BBGlobalDefinitions.gamePhaseDetail)
                {
                    case BBGlobalDefinitions.GamePhaseDetail.Flop:
                        ...
                        {
                            int maxCardValue = 0;
                            string cardsRes = GetComponent<BBPlayerCardsResultValueController>()
                                .getCardsResult(0, out maxCardValue)
                                .ToString();
                            GameActionButtonsRoot
                                .Find("ImageCardsContainer/TextCardsResult")
                                .GetComponent<Text>().text = cardsRes;
                        }
                        break;
        ...
        Texture2D getCardImage(Vector2 cardVal)
        {
            ...
            switch ((int)cardVal.x)
            {
                case 1:
                    ...
                    {
                        case 1:
                            tmpret = (Texture2D)Resources.Load("1_c");
                            break;
                        case 2:
                            tmpret = (Texture2D)Resources.Load("2_c");
                            break;
                        case 3:
                            tmpret = (Texture2D)Resources.Load("3_c");
                            break;
                        case 4:
                            tmpret = (Texture2D)Resources.Load("4_c");
                            break;
                        case 5:
                            tmpret = (Texture2D)Resources.Load("5_c");
                            break;
                        case 6:
                            tmpret = (Texture2D)Resources.Load("6_c");
                            break;
                        case 7:
                            tmpret = (Texture2D)Resources.Load("7_c");
                            break;
                        case 8:
                            tmpret = (Texture2D)Resources.Load("8_c");
                            break;
                        case 9:
                            tmpret = (Texture2D)Resources.Load("9_c");
                            break;
                        case 10:
                            tmpret = (Texture2D)Resources.Load("10_c");
                            break;
                        case 11:
                            tmpret = (Texture2D)Resources.Load("11_c");
                            break;
                        case 12:
                            tmpret = (Texture2D)Resources.Load("12_c");
                            break;
                        case 13:
                            tmpret = (Texture2D)Resources.Load("13_c");
                            break;
                    }
                    break;
                case 2:
                    ...
                    {
                        case 1:
                            tmpret = (Texture2D)Resources.Load("1_f");
                            break;
                        case 2:
                            tmpret = (Texture2D)Resources.Load("2_f");
                            break;
                        case 3:
                            tmpret = (Texture2D)Resources.Load("3_f");
                            break;
                        case 4:
                            tmpret = (Texture2D)Resources.Load("4_f");
                            break;
                        case 5:
                            tmpret = (Texture2D)Resources.Load("5_f");
                            break;
                        case 6:
                            tmpret = (Texture2D)Resources.Load("6_f");
                            break;
                        case 7:
                            tmpret = (Texture2D)Resources.Load("7_f");
                            break;
                        case 8:
                            tmpret = (Texture2D)Resources.Load("8_f");
                            break;
                        case 9:
                            tmpret = (Texture2D)Resources.Load("9_f");
                            break;
                        case 10:
                            tmpret = (Texture2D)Resources.Load("10_f");
                            break;
                        case 11:
                            tmpret = (Texture2D)Resources.Load("11_f");
                            break;
                        case 12:
                            tmpret = (Texture2D)Resources.Load("12_f");
                            break;
                        case 13:
                            tmpret = (Texture2D)Resources.Load("13_f");
                            break;
                    }
                    break;
                case 3:
                    ...
                    {
                        case 1:
                            tmpret = (Texture2D)Resources.Load("1_p");
                            break;
                        case 2:
                            tmpret = (Texture2D)Resources.Load("2_p");
                            break;
                        case 3:
                            tmpret = (Texture2D)Resources.Load("3_p");
                            break;
                        case 4:
                            tmpret = (Texture2D)Resources.Load("4_p");
                            break;
                        case 5:
                            tmpret = (Texture2D)Resources.Load("5_p");
                            break;
                        case 6:
                            tmpret = (Texture2D)Resources.Load("6_p");
                            break;
                        case 7:
                            tmpret = (Texture2D)Resources.Load("7_p");
                            break;
                        case 8:
                            tmpret = (Texture2D)Resources.Load("8_p");
                            break;
                        case 9:
                            tmpret = (Texture2D)Resources.Load("9_p");
                            break;
                        case 10:
                            tmpret = (Texture2D)Resources.Load("10_p");
                            break;
                        case 11:
                            tmpret = (Texture2D)Resources.Load("11_p");
                            break;
                        case 12:
                            tmpret = (Texture2D)Resources.Load("12_p");
                            break;
                        case 13:
                            tmpret = (Texture2D)Resources.Load("13_p");
                            break;
                    }
                    break;
                case 4:
                    ...
                    {
                        case 1:
                            tmpret = (Texture2D)Resources.Load("1_q");
                            break;
                        case 2:
                            tmpret = (Texture2D)Resources.Load("2_q");
                            break;
                        case 3:
                            tmpret = (Texture2D)Resources.Load("3_q");
                            break;
                        case 4:
                            tmpret = (Texture2D)Resources.Load("4_q");
                            break;
                        case 5:
                            tmpret = (Texture2D)Resources.Load("5_q");
                            break;
                        case 6:
                            tmpret = (Texture2D)Resources.Load("6_q");
                            break;
                        case 7:
                            tmpret = (Texture2D)Resources.Load("7_q");
                            break;
                        case 8:
                            tmpret = (Texture2D)Resources.Load("8_q");
                            break;
                        case 9:
                            tmpret = (Texture2D)Resources.Load("9_q");
                            break;
                        case 10:
                            tmpret = (Texture2D)Resources.Load("10_q");
                            break;
                        case 11:
                            tmpret = (Texture2D)Resources.Load("11_q");
                            break;
                        case 12:
                            tmpret = (Texture2D)Resources.Load("12_q");
                            break;
                        case 13:
                            tmpret = (Texture2D)Resources.Load("13_q");
                            break;
                    }
                    break;
            }
