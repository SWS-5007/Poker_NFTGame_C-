...
namespace BLabTexasHoldEmProject
{
    ...
    {
        public enum TestSimulateAiCommand
        {
            None,
            Call,
            Fold,
        ...
        [HideInInspector]
        public BBGlobalDefinitions.GamePhaseDetail[] simulateAiPhasePlayers_FirstBettingRound =
            new BBGlobalDefinitions.GamePhaseDetail[10];
        public TestSimulateAiCommand[] simulateAiCommandPlayers_FirstBettingRound =
            new TestSimulateAiCommand[10];
        [HideInInspector]
        public BBGlobalDefinitions.GamePhaseDetail[] simulateAiPhasePlayers_ClosingPreFlop =
            new BBGlobalDefinitions.GamePhaseDetail[10];
        public TestSimulateAiCommand[] simulateAiCommandPlayers_ClosingPreFlop =
            new TestSimulateAiCommand[10];
        [HideInInspector]
        public BBGlobalDefinitions.GamePhaseDetail[] simulateAiPhasePlayers_Flop =
            new BBGlobalDefinitions.GamePhaseDetail[10];
        public TestSimulateAiCommand[] simulateAiCommandPlayers_Flop = new TestSimulateAiCommand[
            10
        ];
        [HideInInspector]
        public BBGlobalDefinitions.GamePhaseDetail[] simulateAiPhasePlayers_ClosingFlop =
            new BBGlobalDefinitions.GamePhaseDetail[10];
        public TestSimulateAiCommand[] simulateAiCommandPlayers_ClosingFlop =
            new TestSimulateAiCommand[10];
        [HideInInspector]
        public BBGlobalDefinitions.GamePhaseDetail[] simulateAiPhasePlayers_Turn =
            new BBGlobalDefinitions.GamePhaseDetail[10];
        public TestSimulateAiCommand[] simulateAiCommandPlayers_Turn = new TestSimulateAiCommand[
            10
        ];
        ...
        void Start()
        {
            for (int x = 0; x < simulateAiPhasePlayers_FirstBettingRound.Length; x++)
                simulateAiPhasePlayers_FirstBettingRound[x] =
                    BBGlobalDefinitions.GamePhaseDetail.FirstBettingRound;
            for (int x = 0; x < simulateAiPhasePlayers_ClosingPreFlop.Length; x++)
                simulateAiPhasePlayers_ClosingPreFlop[x] =
                    BBGlobalDefinitions.GamePhaseDetail.ClosingPreFlop;
            for (int x = 0; x < simulateAiPhasePlayers_Flop.Length; x++)
                simulateAiPhasePlayers_Flop[x] = BBGlobalDefinitions.GamePhaseDetail.Flop;
            for (int x = 0; x < simulateAiPhasePlayers_ClosingFlop.Length; x++)
                simulateAiPhasePlayers_ClosingFlop[x] =
                    BBGlobalDefinitions.GamePhaseDetail.ClosingFlop;
            for (int x = 0; x < simulateAiPhasePlayers_Turn.Length; x++)
                simulateAiPhasePlayers_Turn[x] = BBGlobalDefinitions.GamePhaseDetail.Turn;
        }
        ...
        {
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[1].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[1].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[2].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[2].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[3].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[3].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[4].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[4].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[5].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[5].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[6].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[6].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[7].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[7].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[8].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[8].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[9].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[9].simulateAllCardsValue[1]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[0].simulateAllCardsValue[0]
            );
            GetComponent<BBGameController>().GlobalDeck.Add(
                simulateCardValuerForPlayerID[0].simulateAllCardsValue[1]
            );
            // players cards end
            // to burn
            GetComponent<BBGameController>().GlobalDeck.Add(new Vector2(1, 1));
