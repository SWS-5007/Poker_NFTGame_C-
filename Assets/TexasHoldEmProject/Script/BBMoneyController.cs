    ...
    public class BBMoneyController : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (_BBGameController._BBGlobalDefinitions.isAnOpenGame)
            {
                ...
                {
                    _BBGameController.playerDataList[x].currentPlayerTotalMoney =
                        _BBGameController._BBGlobalDefinitions.playersCashDuringOpenGame[x];
                    _BBGameController.playerDataList[x].runOutOfMoney =
                        _BBGameController._BBGlobalDefinitions.playersStateIsOutDuringOpenGame[x];
                }
                _BBGameController._BBGlobalDefinitions.smallBlindValue =
                    _BBGameController._BBGlobalDefinitions.limitedLow
                    * BBStaticData.cardsHandProgressive;
                _BBGameController._BBGlobalDefinitions.bigBlindValue =
                    _BBGameController._BBGlobalDefinitions.limitedHight
                    * BBStaticData.cardsHandProgressive;
            }
            else
            {
                ...
                {
                    _BBGameController._BBGlobalDefinitions.playersCashDuringOpenGame[
                        _BBGameController._BBGlobalDefinitions.localPlayer
                    ] = _BBGameController._BBGlobalDefinitions.localPlayerMoneyValueSimulation;
                }
                _BBGameController._BBGlobalDefinitions.smallBlindValue =
                    _BBGameController._BBGlobalDefinitions.limitedLow;
                _BBGameController._BBGlobalDefinitions.bigBlindValue =
...
*/
            ...
            else
            {
                ...
                {
                    if (
                        _BBGameController.playerDataList[playerID].currentPlayerTotalMoney
                        >= valueToBet
                    )
                    {
                        return true;
            ...
            switch (gamePhase)
            {
                case BBGlobalDefinitions.GamePhaseDetail.FirstBettingRound:
                    ...
                    switch (_BBGameController._BBGlobalDefinitions.roundRaiseCounter)
                    {
                        case 1:
                            raiseBetVal =
                                _BBGameController._BBGlobalDefinitions.smallBlindValue * 2;
                            break;
                        case 2:
                            raiseBetVal =
                                _BBGameController._BBGlobalDefinitions.smallBlindValue * 3;
                            break;
                        case 3:
                            raiseBetVal =
                                _BBGameController._BBGlobalDefinitions.smallBlindValue * 4;
                            break;
                        default:
