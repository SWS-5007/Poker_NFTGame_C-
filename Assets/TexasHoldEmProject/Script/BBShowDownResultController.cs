...
namespace BLabTexasHoldEmProject
{
    public class BBShowDownResultController : MonoBehaviour
    {
        ...
        {
            public Vector2[] simulateAllCardsValue =
            {
                new Vector2(1, 2),
                new Vector2(2, 4),
                new Vector2(1, 4),
        ...
        public SimulateCardValuerForPlayerID[] simulateCardValuerForPlayerID =
            new SimulateCardValuerForPlayerID[10];
        ...
        public Vector2[] simulateAllCardsValueForPoker =
        {
            new Vector2(1, 8),
            new Vector2(2, 4),
            new Vector2(2, 8),
        ...
        public class PlayersCValue
        {
            ...
            public BBPlayerCardsResultValueController.CardsValues CValue =
                BBPlayerCardsResultValueController.CardsValues.Null;
        ...
        public List<PlayersCValue> playersCVal =
            new List<BBShowDownResultController.PlayersCValue>();
        ...
        void popolateAllResults()
        {
            ...
            for (int x = 0; x < BBGC.playerDataList.Count; x++)
            {
                ...
                {
                    BBPlayerCardsResultValueController.CardsValues res =
                        GetComponent<BBPlayerCardsResultValueController>()
                            .getCardsResult(x, out maxRes);

                    if (simulateTwoPair[x])
                        res = BBPlayerCardsResultValueController.CardsValues.TwoPair;
                    else if (simulateThreeOfAkind[x])
                        res = BBPlayerCardsResultValueController.CardsValues.ThreeOfAkind;
                    else if (simulateStraight[x])
                        res = BBPlayerCardsResultValueController.CardsValues.Straight;
                    else if (simulateFlush[x])
                        res = BBPlayerCardsResultValueController.CardsValues.Flush;
                    else if (simulateFullHouse[x])
                        res = BBPlayerCardsResultValueController.CardsValues.FullHouse;
                    else if (simulatePoker[x])
                        res = BBPlayerCardsResultValueController.CardsValues.Poker;
                    else if (simulateStraightFlush[x])
                        res = BBPlayerCardsResultValueController.CardsValues.StraightFlush;
                    else if (simulateRoyalFlush[x])
                        res = BBPlayerCardsResultValueController.CardsValues.RoyalFlush;
                ...
                {
                    Debug.Log(
                        "<-------------->-->BBShowDownResultController--->>popolateAllResults--> ID : "
                            + x
                            + " resVal : "
                            + playersCVal[x].CValue
                            + " C1 : "
                            + playersCVal[x].card_1
                            + " C2 : "
                            + playersCVal[x].card_2
                            + " maxV : "
                            + playersCVal[x].maxCVal
                    );
                    BBGC.playerDataList[x].T_PlayerMoneyTotal.text = playersCVal[
                        x
                    ].CValue.ToString();
                }
            }
        ...
        int[] getBestFive(
            BBPlayerCardsResultValueController.CardsValues cardval,
            int playerID,
            Vector2 card_1,
            Vector2 card_2
        )
        {
            ...
            if (simulateTwoPair[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.TwoPair;
            }
            else if (simulateThreeOfAkind[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                ;
                cardval = BBPlayerCardsResultValueController.CardsValues.ThreeOfAkind;
            }
            else if (simulateStraight[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.Straight;
            }
            else if (simulateFlush[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.Flush;
            }
            else if (simulateFullHouse[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.FullHouse;
            }
            else if (simulatePoker[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.Poker;
            }
            else if (simulateStraightFlush[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.StraightFlush;
            }
            else if (simulateRoyalFlush[playerID])
            {
                allCards = simulateCardValuerForPlayerID[playerID].simulateAllCardsValue;
                cardval = BBPlayerCardsResultValueController.CardsValues.RoyalFlush;
            }
            else if (simulatePokerOnTable)
            {
                //allCards = simulateAllCardsValue;
                BBGC.flopCardList[0] = new Vector2(1, 8);
                BBGC.flopCardList[1] = new Vector2(2, 8);
                BBGC.flopCardList[2] = new Vector2(3, 8);
                BBGC.turnCard = new Vector2(4, 8);
                BBGC.riverCard = new Vector2(2, 9);
            ...
            switch (cardval)
            {
                case BBPlayerCardsResultValueController.CardsValues.HighCard:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterHighCard playerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.Pair:
                    ...
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getPairValue tmpPairCardVal : "
                                + tmpPairCardVal
                                + " PlayerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.TwoPair:
                    ...
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getTwoPairValue _tmpPairCardVal : "
                                + _tmpPairCardVal[0]
                                + " : "
                                + _tmpPairCardVal[1]
                                + " PlayerID : "
                ...
                case BBPlayerCardsResultValueController.CardsValues.ThreeOfAkind:
                    ...
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getThreeOfAkindValue tmpPairCardValT : "
                                + tmpPairCardValT
                                + " PlayerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.Straight:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterStraight playerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.Flush:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterFlush playerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.FullHouse:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterFullHouse playerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.Poker:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterPoker playerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.StraightFlush:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterStraightFlush playerID : "
                                + playerID
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.RoyalFlush:
                    if (logResult)
                        Debug.Log(
                            "<-------------->-->BBShowDownResultController--->>getBestFive-->getCompleteBestAfterRoyalFlush playerID : "
                                + playerID
                        );
        ...
        public void executeFinalShowDown()
        {
            ...
            onlyOpenCardsValue = GetComponent<BBPlayerCardsResultValueController>()
                .getOpenCardsResult(
                    BBGC.flopCardList,
                    BBGC.turnCard,
                    BBGC.riverCard,
            ...
            Debug.Log(
                "[BBShowDownResultController][executeFinalShowDown] onlyOpenCardsValue =============>> : "
                    + onlyOpenCardsValue
                    + " : "
                    + maxCardVal
            );
...
*/
        ...
        void executeWinnerCheck()
        {
            ...
            if (testTwoPair)
                goto TestTwoPair;
            if (testForPairHighCard)
                goto TestPairHighCard;
            if (testThreeOfAkind)
                goto TestThreeOfAkind;

            BBPlayerCardsResultValueController.CardsValues toCheck =
                BBPlayerCardsResultValueController.CardsValues.RoyalFlush;

            for (int x = 0; x < playersCVal.Count; x++)
            {
                if (playersCVal[x].CValue == toCheck)
                {
                    tmpWinnerList.Add(playersCVal[x]);
                }
            }

            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking RoyalFlush : " + tmpWinnerList.Count
            );

            if (tmpWinnerList.Count > 0)
            {
                payWinner(toCheck, tmpWinnerList);
                return;
            }
            //-----------------------------
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking StraightFlush : "
                    + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking Poker : " + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking FullHouse : " + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking Flush : " + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking Straight : " + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking ThreeOfAkind : "
                    + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking TwoPair : " + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking Pair : " + tmpWinnerList.Count
            );
            ...
            Debug.Log(
                ">>>>-------executeWinnerCheck>>>>>>>>checking HighCard : " + tmpWinnerList.Count
            );
        ...
        void executeRoundEnd(List<FinalResultStruct> winner)
        {
            ...
            if (winner.Count > 1)
            {
                ...
                for (int x = 0; x < winner.Count; x++)
                {
                    ...
                    BBGC.playerDataList[winner[x].playerID].currentPlayerTotalMoney =
                        BBGC.playerDataList[winner[x].playerID].currentPlayerTotalMoney
                        + splittedValue;
                }
            }
            else
            {
                ...
                BBGC.playerDataList[winner[0].playerID].currentPlayerTotalMoney =
                    BBGC.playerDataList[winner[0].playerID].currentPlayerTotalMoney + totalPot;
            }
        ...
        public IEnumerator rotateCoveredCards()
        {
            ...
            for (int x = 0; x < BBGC.playerDataList.Count; x++)
            {
                if (!BBGC.playerDataList[x].isOutOfGame)
                {
                    ...
                    GetComponent<BBSoundController>()
                        .playClip(GetComponent<BBSoundController>().rotateCard);
        ...
        IEnumerator showFinalPlayersResult()
        {
            ...
            for (int x = 0; x < playersCVal.Count; x++)
            {
                ...
                Image AvatarImage = playerFinalResultUIList[x].transform
                    .Find("ImageAvatar")
                    .GetComponent<Image>();
                AvatarImage.overrideSprite = sprite;
                playerFinalResultUIList[x].transform
                    .Find("TextPlayerPosition")
                    .GetComponent<Text>().text = "(" + (x + 1).ToString() + ")";

                if (playersCVal[x].isRoundOut)
                {
                    sprite = Resources.Load<Sprite>("star-fold");
                    Image wonLoseImage = playerFinalResultUIList[x].transform
                        .Find("ImageWonLose")
                        .GetComponent<Image>();
                    wonLoseImage.overrideSprite = sprite;
                }
                else
                {
                    if (playersCVal[x].won)
                    {
                        sprite = Resources.Load<Sprite>("star-won");
                        Image wonLoseImage = playerFinalResultUIList[x].transform
                            .Find("ImageWonLose")
                            .GetComponent<Image>();
                        wonLoseImage.overrideSprite = sprite;
                    }
                    else if (!playersCVal[x].won)
                    {
                        sprite = Resources.Load<Sprite>("star-lose");
                        Image wonLoseImage = playerFinalResultUIList[x].transform
                            .Find("ImageWonLose")
                            .GetComponent<Image>();
                        wonLoseImage.overrideSprite = sprite;
                ...
                string humanIcon = "";
                if (BBGC._BBGlobalDefinitions.localPlayer == playersCVal[x].playerPosID)
                    humanIcon = "Human-icon";
                else
                    humanIcon = "CPU-icon";
                sprite = Resources.Load<Sprite>(humanIcon);
                Image wonLoseImage2 = playerFinalResultUIList[x].transform
                    .Find("ImageHumanCpu")
                    .GetComponent<Image>();
                wonLoseImage2.overrideSprite = sprite;

                playerFinalResultUIList[x].transform
                    .Find("TextPlayerName")
                    .GetComponent<Text>().text = BBGC.playerDataList[x].T_playerName.text;
                ...
                else
                {
                    playerFinalResultUIList[x].transform
                        .Find("TextResult")
                        .GetComponent<Text>().text = getFormattedBestFive(playersCVal[x].bestFive);
                    playerFinalResultUIList[x].transform
                        .Find("TextBestFive")
                        .GetComponent<Text>().text = playersCVal[x].CValue.ToString();
                }
                ...
                if (playersCVal[x].won)
                {
                    ...
                    wonCounter++;
                    playerFinalResultUIList[x].transform
                        .Find("TextMoneyResult")
                        .GetComponent<Text>().text =
                        BBStaticData.getMoneyValue(playersCVal[x].splittedValue)
                        + "/"
                        + BBStaticData.getMoneyValue(
                            BBGC.playerDataList[x].currentPlayerTotalMoney
                        );
                    playerFinalResultUIList[x].transform
                        .Find("TextMoneyResult")
                ...
                else
                {
                    playerFinalResultUIList[x].transform
                        .Find("TextMoneyResult")
                        .GetComponent<Text>().text =
                        BBStaticData.getMoneyValue(BBGC.playerDataList[x].currentMoneyOnTable)
                        + "/"
                        + BBStaticData.getMoneyValue(
                            BBGC.playerDataList[x].currentPlayerTotalMoney
                        );
                ...
                if (playersCVal[x].CValue == BBPlayerCardsResultValueController.CardsValues.TwoPair)
                {
                    playerFinalResultUIList[x].transform
                        .Find("TextBestKicker")
                        .GetComponent<Text>().text = getFormattedValue(
                        (int)BBGC.playerDataList[x].TwoPairData.z
                    );
                }
                if (playersCVal[x].kickerOnPlayerCard[0] != 0)
                {
                    playerFinalResultUIList[x].transform
                        .Find("TextBestKicker")
                        .GetComponent<Text>().text = getFormattedValue(
                        playersCVal[x].kickerOnPlayerCard[0]
                    );
                }
            }
            ...
            if (localPlayerWon)
            {
                ...
                {
                    if (bbpd.runOutOfMoney)
                        runOut++;
                }
                if (runOut > 8)
                {
                    BBGC.executeLocalPlayerWon(
                        BBGC.playerDataList[
                            BBGC._BBGlobalDefinitions.localPlayer
                        ].currentPlayerTotalMoney + BBGC._BBGlobalDefinitions.moneyOnTable,
                        true
                    );
                    yield break;
                }
            ...
            Debug.Log(
                "||||||||||||||||||||||||||| showFinalPlayersResult outCounter : " + outCounter
            );
        ...
        void payWinner(
            BBPlayerCardsResultValueController.CardsValues wonKind,
            List<PlayersCValue> winners
        )
        {
            ...
            switch (wonKind)
            {
                case BBPlayerCardsResultValueController.CardsValues.HighCard:
                    ...
                    foreach (int[] v in tmpResHighCardsList)
                    {
                        ...
                        lastRes.cardsResult =
                            BBPlayerCardsResultValueController.CardsValues.HighCard;
                        lastRes.best_1 = v[0];
                        lastRes.best_2 = v[1];
                        lastRes.best_3 = v[2];
                        lastRes.best_4 = v[3];
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForHighCard ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                                + ":"
                ...
                case BBPlayerCardsResultValueController.CardsValues.Pair:
                    ...
                    foreach (int[] v in tmpResList)
                    {
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForPair ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                                + ":"
                ...
                case BBPlayerCardsResultValueController.CardsValues.TwoPair:
                    ...
                    foreach (Vector4 v in tmpResListTwoPair)
                    {
                        FinalResultStruct lastRes = new FinalResultStruct();
                        lastRes.cardsResult =
                            BBPlayerCardsResultValueController.CardsValues.TwoPair;
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForTwoPair ->>>>>>>>>>>>>> tmpResList : "
                                + v.y
                                + ":"
                                + v.x
                                + ":"
                ...
                case BBPlayerCardsResultValueController.CardsValues.ThreeOfAkind:
                    ...
                    List<int[]> tmpResThreeOfAkindList = getFinalResultForThreeOfAkind(
                        tmpResThreeOfAkind
                    );
                    ...
                    foreach (int[] v in tmpResThreeOfAkindList)
                    {
                        FinalResultStruct lastRes = new FinalResultStruct();
                        lastRes.cardsResult =
                            BBPlayerCardsResultValueController.CardsValues.ThreeOfAkind;
                        lastRes.best_1 = v[0];
                        lastRes.best_2 = v[1];
                        lastRes.best_3 = v[2];
                        lastRes.best_4 = -1;
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForThreeOfAkind ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                                + ":"
                ...
                case BBPlayerCardsResultValueController.CardsValues.Straight:
                    ...
                    foreach (int[] v in tmpResStraightList)
                    {
                        FinalResultStruct lastRes = new FinalResultStruct();
                        lastRes.cardsResult =
                            BBPlayerCardsResultValueController.CardsValues.Straight;
                        lastRes.best_1 = v[0];
                        lastRes.best_2 = -1;
                        lastRes.best_3 = -1;
                        lastRes.best_4 = -1;
                ...
                case BBPlayerCardsResultValueController.CardsValues.Flush:
                    ...
                    foreach (int[] v in tmpResFlushList)
                    {
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForFromFlush ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.FullHouse:
                    ...
                    foreach (int[] v in tmpResFullHouseList)
                    {
                        FinalResultStruct lastRes = new FinalResultStruct();
                        lastRes.cardsResult =
                            BBPlayerCardsResultValueController.CardsValues.FullHouse;
                        lastRes.best_1 = v[0];
                        lastRes.best_2 = v[1];
                        lastRes.best_3 = -1;
                        lastRes.best_4 = -1;
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForFromFullHouse ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                                + ":"
                ...
                case BBPlayerCardsResultValueController.CardsValues.Poker:
                    ...
                    foreach (int[] v in tmpResPokerList)
                    {
                        ...
                        Debug.Log(
                            ">>>>---payWinner---getFinalResultForFromPoker ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.StraightFlush:
                    ...
                    {
                        int[] res = new int[2];
                        res[0] = BBGC.playerDataList[pcv.playerPosID].StraightFlushMaxCardDataValue;
                        res[1] = pcv.playerPosID;
                        tmpSFList.Add(res);
                    }
                    int maxVal = 0;
                    for (int x = 0; x < tmpSFList.Count; x++)
                    {
                        if (tmpSFList[x][0] > maxVal)
                            maxVal = tmpSFList[x][0];
                    }
                    Debug.Log(
                        ">>>>---payWinner---StraightFlush ->>>>>>>>>>>>>> maxVal : " + maxVal
                    );
                    List<int[]> lastList = new List<int[]>();
                    foreach (int[] r in tmpSFList)
                    {
                        if (r[0] == maxVal)
                        {
                            lastList.Add(r);
                    ...
                    foreach (int[] v in lastList)
                    {
                        FinalResultStruct lastRes = new FinalResultStruct();
                        lastRes.cardsResult =
                            BBPlayerCardsResultValueController.CardsValues.StraightFlush;
                        lastRes.best_1 = v[0];
                        lastRes.best_2 = -1;
                        lastRes.best_3 = -1;
                        lastRes.best_4 = -1;
                        ...
                        Debug.Log(
                            ">>>>---payWinner---StraightFlush ->>>>>>>>>>>>>> tmpResList : "
                                + v[0]
                                + ":"
                                + v[1]
                        );
                ...
                case BBPlayerCardsResultValueController.CardsValues.RoyalFlush:
                    ...
                    foreach (PlayersCValue v in winners)
                    {
                        ...
                        Debug.Log(
                            ">>>>---payWinner---RoyalFlush ->>>>>>>>>>>>>> tmpResList : "
                                + lastResRoyalFlush.best_1
                                + ":"
                                + lastResRoyalFlush.playerID
                        );
                    }
...
*/
        ...
        List<int[]> getFinalResultForFromFullHouse(List<PlayersCValue> winners)
        {
            ...
            {
                if (r[0] == maxValFirst)
                    firstCheckList.Add(r);
            }

            if (firstCheckList.Count > 1)
            {
                foreach (int[] r in firstCheckList)
                {
                    if (r[1] > maxValSecond)
                        maxValSecond = r[1];
                }
                ...
                {
                    if (r[1] == maxValSecond)
                        secondCheckList.Add(r);
                }
                foreach (int[] r in secondCheckList)
                    Debug.Log(
                        "getFinalResultForFromFullHouse maxValSecond --> res : "
                            + r[0]
                            + ":"
                            + r[1]
                            + ":"
            ...
            else
            {
                foreach (int[] r in firstCheckList)
                    Debug.Log(
                        "getFinalResultForFromFullHouse maxValFirst --> res : "
                            + r[0]
                            + ":"
                            + r[1]
                            + ":"
        ...
        List<int[]> getFinalResultForFromFlush(List<PlayersCValue> winners)
        {
            ...
            foreach (int[] r in resList)
                Debug.Log(
                    "-------------------resList-------1----------------------------->>getBestResultFromFlush --> maxVal : "
                        + maxVal
                        + " : "
                        + r[0]
                        + " : "
                        ...
                        + winners.Count
                        + " kicker : "
                        + BBGC.playerDataList[r[1]].FlushMaxCardDataValueKicker
                );
            ...
            for (int x = 0; x < openCardsList.Length; x++)
            {
                if (openCardsList[x].y == 1)
                    openCardsList[x].y = 14;
            }
            ...
            {
                ValOnPlayerscards[x] =
                    BBGC.playerDataList[winners[x].playerPosID].FlushMaxCardDataValueKicker;
            }
            ...
            foreach (Vector2 v in openCardsList)
            {
                if (v.x == seed)
                {
                    if (v.y == maxVal)
                    {
                        gotCardOnOpen = true;
                        Debug.Log(
                            "---------------------2A-------------------openCardsList------gotCardOnOpen--------->>getBestResultFromFlush --> maxVal : "
                                + v
                                + " gotCardOnOpen: "
                                + gotCardOnOpen
                        );
                ...
                Debug.Log(
                    "---------------------2-------------------openCardsList--------------->>getBestResultFromFlush --> maxVal : "
                        + v
                );
            }
            ...
            if (gotCardOnOpen)
            {
                ...
                {
                    Debug.Log(
                        "---------------------3-------------------openCardsList-------gotCardOnOpen-------->>getBestResultFromFlush --> maxVal : "
                            + maxVal
                            + " : "
                            + x
                            + " : "
                            + BBGC.playerDataList[
                                winners[x].playerPosID
                            ].FlushMaxCardDataValueKicker
                            + " : "
                            + winners[x].playerPosID
                    );
                    if (
                        maxValOnPlayersCards
                        == BBGC.playerDataList[winners[x].playerPosID].FlushMaxCardDataValueKicker
                    )
                    {
                        Debug.Log(
                            "---------------------3AA-------------------openCardsList-------gotCardOnOpen-------->>getBestResultFromFlush --> maxVal : "
                                + maxVal
                                + " : "
                                + x
                        );
                        ...
                        returnList.Add(r);
                        playersCVal[winners[x].playerPosID].kickerOnPlayerCard[0] =
                            maxValOnPlayersCards;
                    }
                }
            }
            else
            {
                foreach (int[] r in resList)
                {
                    if (r[0] == maxVal)
                        returnList.Add(r);
                    Debug.Log(
                        "---------------------4-------------------returnList--------------->>getBestResultFromFlush --> maxVal : "
                            + r
                    );
                }
            }
            ...
            if (returnList.Count > 1)
                foreach (int[] r in returnList)
                    Debug.Log("getBestResultFromStraight --> res : " + r[0] + ":" + r[1]);
        ...
        List<int[]> getFinalResultForHighCardGetRank(List<int[]> winners, int checkValCode)
        {
            ...
            for (int x = 0; x < winners.Count; x++)
            {
                for (int j = 0; j < winners.Count; j++)
                {
                    Debug.Log(
                        "--0-->>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : "
                            + winners[x][checkValCode]
                            + ":"
                            + winners[j][checkValCode]
                    ); // + " result : " + result[x]);
                    float m = Mathf.Max(winners[x][checkValCode], winners[j][checkValCode]);
                    if (m >= maxVal)
                    {
                        maxVal = m;
                    }
        ...
        List<int[]> getFinalResultForHighCard(List<int[]> winners)
        {
            ...
            if (finalResult.Count > 1)
            {
                ...
                foreach (int[] r in finalResult_2)
                {
                    Debug.Log(
                        "*********************finalResult_2******************************* check 1 --> : "
                            + r[0]
                            + ":"
                            + r[1]
                            + ":"
            ...
            if (finalResult_2.Count > 1)
            {
                ...
                foreach (int[] r in finalResult_3)
                {
                    Debug.Log(
                        "*********************finalResult_3******************************* check 2 --> : "
                            + r[0]
                            + ":"
                            + r[1]
                            + ":"
            ...
            if (finalResult_3.Count > 1)
            {
                ...
                foreach (int[] r in finalResult_4)
                {
                    Debug.Log(
                        "*********************finalResult_4******************************* check 3 --> : "
                            + r[0]
                            + ":"
                            + r[1]
                            + ":"
            ...
            if (finalResult_4.Count > 1)
            {
                ...
                foreach (int[] r in finalResult_5)
                {
                    Debug.Log(
                        "*********************finalResult_5******************************* check 4 --> : "
                            + r[0]
                            + ":"
                            + r[1]
                            + ":"
        ...
        List<int[]> getBestResultFromHighCard(List<PlayersCValue> winners)
        {
            ...
            {
                int[] tmp = new int[6];
                if (BBGC.playerDataList[winners[x].playerPosID].HighCardData[0] == 1)
                    tmp[0] = 14;
                else
                    tmp[0] = BBGC.playerDataList[winners[x].playerPosID].HighCardData[0];
                if (BBGC.playerDataList[winners[x].playerPosID].HighCardData[1] == 1)
                    tmp[1] = 14;
                else
                    tmp[1] = BBGC.playerDataList[winners[x].playerPosID].HighCardData[1];
                if (BBGC.playerDataList[winners[x].playerPosID].HighCardData[2] == 1)
                    tmp[2] = 14;
                else
                    tmp[2] = BBGC.playerDataList[winners[x].playerPosID].HighCardData[2];
                if (BBGC.playerDataList[winners[x].playerPosID].HighCardData[3] == 1)
                    tmp[3] = 14;
                else
                    tmp[3] = BBGC.playerDataList[winners[x].playerPosID].HighCardData[3];
                if (BBGC.playerDataList[winners[x].playerPosID].HighCardData[4] == 1)
                    tmp[4] = 14;
                else
                    tmp[4] = BBGC.playerDataList[winners[x].playerPosID].HighCardData[4];
        ...
        List<int[]> getFinalResultForPair(List<int[]> winners)
        {
            ...
            foreach (ListPairCheckVal l in BBRes)
                Debug.Log(
                    l.pairVal + ":" + l.H_Val_1 + ":" + l.H_Val_2 + ":" + l.H_Val_3 + ":" + l.PId
                );
            ...
            if (BBRes.Count > 1)
            {
                ...
                foreach (ListPairCheckVal lpc in BBRes)
                {
                    ...
                    newVal[0] = lpc.pairVal;
                    newVal[1] = lpc.H_Val_1;
                    newVal[2] = lpc.H_Val_2;
                    newVal[3] = lpc.H_Val_3;
                    newVal[4] = lpc.PId;
                    check2.Add(newVal);
                }
                List<ListPairCheckVal> BBRes2 = FindBestSinglePair(check2, 1);
                Debug.Log("================================>>> BBRes2 : " + BBRes2.Count);
                foreach (ListPairCheckVal l in BBRes2)
                    Debug.Log(
                        l.pairVal
                            + ":"
                            + l.H_Val_1
                ...
                if (BBRes2.Count > 1)
                {
                    ...
                    if (BBRes3.Count > 1)
                    {
                        ...
                        foreach (ListPairCheckVal l in BBRes4)
                            Debug.Log(
                                l.pairVal
                                    + ":"
                                    + l.H_Val_1
        ...
        List<int[]> getBestResultFromPair(List<PlayersCValue> winners)
        {
            ...
            {
                int[] tmp = new int[5];
                if (BBGC.playerDataList[winners[x].playerPosID].PairData[0] == 1)
                    tmp[0] = 14;
                else
                    tmp[0] = BBGC.playerDataList[winners[x].playerPosID].PairData[0];
                if (BBGC.playerDataList[winners[x].playerPosID].PairData[1] == 1)
                    tmp[1] = 14;
                else
                    tmp[1] = BBGC.playerDataList[winners[x].playerPosID].PairData[1];
                if (BBGC.playerDataList[winners[x].playerPosID].PairData[2] == 1)
                    tmp[2] = 14;
                else
                    tmp[2] = BBGC.playerDataList[winners[x].playerPosID].PairData[2];
                if (BBGC.playerDataList[winners[x].playerPosID].PairData[3] == 1)
                    tmp[3] = 14;
                else
                    tmp[3] = BBGC.playerDataList[winners[x].playerPosID].PairData[3];
        ...
        List<Vector4> getFinalResultForTwoPair(Vector4[] tmpRes)
        {
            ...
            if (BBresBest.Count > 1)
            {
                ...
                foreach (Vector4 v in BBresSecond)
                    Debug.Log(v);
                ...
                if (BBresSecond.Count > 1)
                {
                    ...
                    foreach (Vector4 v in BBresHighCard)
                        Debug.Log(v);
        ...
        List<int[]> getFinalResultForThreeOfAkindGetRank(List<int[]> winners, int checkValCode)
        {
            ...
            for (int x = 0; x < winners.Count; x++)
            {
                ...
                {
                    Debug.Log(
                        "getFinalResultForThreeOfAkindGetRank---->>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : "
                            + winners[x][checkValCode]
                            + ":"
                            + winners[j][checkValCode]
                    ); // + " result : " + result[x]);
        ...
        List<int[]> getBestResultFromThreeOfAkind(List<PlayersCValue> winners)
        {
            ...
            for (int x = 0; x < winners.Count; x++)
            {
                ...
                if (BBGC.playerDataList[winners[x].playerPosID].ThreeOfAkindCardData[0] == 1)
                    tmp[0] = 14;
                else
                    tmp[0] = BBGC.playerDataList[winners[x].playerPosID].ThreeOfAkindCardData[0];
                if (BBGC.playerDataList[winners[x].playerPosID].ThreeOfAkindCardData[1] == 1)
                    tmp[1] = 14;
                else
                    tmp[1] = BBGC.playerDataList[winners[x].playerPosID].ThreeOfAkindCardData[1];
                if (BBGC.playerDataList[winners[x].playerPosID].ThreeOfAkindCardData[2] == 1)
                    tmp[2] = 14;
                else
                    tmp[2] = BBGC.playerDataList[winners[x].playerPosID].ThreeOfAkindCardData[2];
        ...
        int[] getCompleteBestAfterStraight(Vector2[] allCards)
        {
            ...
            foreach (Vector2 i in allCards)
                if (logResult)
                    Debug.Log(
                        "------->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterStraight : "
                            + i.x
                            + " : "
                            + i.y
                    );
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 1 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 2 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 3 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 4 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 5 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 6 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 7 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 8 : " + toCheckStarting);
            ...
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 9 : " + toCheckStarting);
            ...
            for (int x = 0; x < checkTEN.Length; x++)
            {
                ...
                if (logResult)
                    Debug.Log("TEST----> : " + " counter : " + counter + " : " + result);
            }
            if (logResult)
                Debug.Log("RESULT----> : " + counter + " checking 10 : " + toCheckStarting);
            counterRes[10] = new Vector2(counter, 10);

            foreach (Vector2 i in counterRes)
                if (logResult)
                    Debug.Log("--counterRes---->> : " + i);
        ...
        int[] getCompleteBestAfterFlush(Vector2[] allCards, int playerID)
        {
            ...
            Debug.Log(
                "---2---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterFlush seed : "
                    + seed
            );
            ...
            for (int x = 0; x < allCards.Length; x++)
            {
                if (allCards[x].x == seed)
                {
                    ...
                    if (
                        (allCards[x].y == BBGC.playerDataList[playerID].card_1_Value.y)
                        || (allCards[x].y == BBGC.playerDataList[playerID].card_2_Value.y)
                    )
                    {
            ...
            Debug.Log(
                "---3---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterFlush onPlayerHandcard : "
                    + onPlayerHandcard.Count
            );
            ...
            foreach (int i in tmpRes)
                if (logResult)
                    Debug.Log(
                        "RESULT------->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterFlush : "
                            + i
                    );
        ...
        int[] getCompleteBestAfterFullHouse(Vector2[] allCards, int playerID)
        {
            ...
            foreach (Vector2 i in allCards)
                if (logResult)
                    Debug.Log(
                        "---1---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterFullHouse : "
                            + i.x
                            + " : "
                            + i.y
                    );
            ...
            foreach (int i in tmpRes)
                if (logResult)
                    Debug.Log(
                        "RESULT------->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterFullHouse : "
                            + i
                    );
        ...
        int[] getCompleteBestAfterStraightFlush(Vector2[] allCards, int playerID)
        {
            ...
            foreach (Vector2 i in allCards)
                if (logResult)
                    Debug.Log(
                        "---1---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterStraightFlush : "
                            + i.x
                            + " : "
                            + i.y
                    );
            ...
            for (int x = 0; x < allCards.Length; x++)
            {
                valListAll.Add(allCards[x]);
            }
            float currentSeed = 1;
            for (int x = 0; x < valListAll.Count; x++)
            {
                if (valListAll[x].x == currentSeed)
                {
                    valListSeed.Add((int)valListAll[x].y);
                }
            }
            ...
            if (logResult)
                Debug.Log(
                    "---2---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterStraightFlush valListSeed.Count : "
                        + valListSeed.Count
                );
            ...
            foreach (int i in tmpRes)
                if (logResult)
                    Debug.Log(
                        "RESULT---3---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterStraightFlush : "
                            + i
                    );
        ...
        int[] getCompleteBestAfterHighCard(Vector2[] allCards, int playerID)
        {
            ...
            foreach (Vector2 i in allCards)
                if (logResult)
                    Debug.Log(
                        "---1---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterHighCard : "
                            + i.y
                    );
            ...
            foreach (int i in tmpRes)
                if (logResult)
                    Debug.Log(
                        "---2---->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterHighCard : "
                            + i
                    );
        ...
        int[] getCompleteBestAfterPoker(Vector2[] allCards, int playerID)
        {
            ...
            if (logResult)
                Debug.Log(
                    "************2*********************** getCompleteBestAfterPoker******************************* pokID : "
                        + pokID
                );
        ...
        int[] getCompleteBestAfterThreeOfAkind(
            int ThreeOfAkindVal,
            Vector2[] cardList,
            int playerID
        )
        {
            ...
            foreach (Vector2 i in cardList)
                if (logResult)
                    Debug.Log(
                        "------->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterThreeOfAkind : "
                            + i.y
                    );
            ...
            foreach (int i in tmpRes)
                if (logResult)
                    Debug.Log(
                        "RESULT--->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterThreeOfAkind : "
                            + i
                    );
        ...
        int[] getTwoPairValue(Vector2[] cardList)
        {
            ...
            for (int x = 0; x < cardList.Length; x++)
            {
                ...
                {
                    if (
                        (cardList[x].y == cardList[j].y)
                        && (((int)cardList[x].y != partVal_1) && ((int)cardList[x].y != partVal_2))
                    )
                    {
                        couter++;
                        if (couter == 2)
 ...
 */
            ...
            Vector4 twoPairValues = new Vector4(
                (float)pairVal[0],
                (float)pairVal[1],
                (float)tmpRes[4],
                (float)playerID
        ...
        int[] getCompleteBestAfterPair(int pairVal, Vector2[] cardList, int playerID)
        {
            ...
            foreach (int i in tmpRes)
                if (logResult)
                    Debug.Log(
                        "RESULT--->>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%getCompleteBestAfterPair : "
                            + i
                    );
        ...
        public List<Vector4> FindMaxSecondPair(List<Vector4> list)
        {
            ...
            Debug.Log(
                "***************FindMaxSecondPair******************* result counter : " + counter
            );
        ...
        public List<Vector4> FindMaxBestpair(List<Vector4> list)
        {
            ...
            Debug.Log(
                "***************FindMaxBestpair******************* result counter : " + counter
            );
        ...
        List<ListPairCheckVal> FindBestSinglePair(List<int[]> list, int listPairCheckValCode)
        {
            ...
            foreach (ListPairCheckVal r in checkList)
                Debug.Log(
                    "checkList : "
                        + r.pairVal
                        + ":"
            ...
            Debug.Log(
                "FindBestSinglePair count : "
                    + list.Count
                    + " listPairCheckValCode : "
                    + listPairCheckValCode
            );
            float maxVal = 0;
                    ...
                    switch (listPairCheckValCode)
                    {
                        case 0:
                            result = checkList.Find(
                                item => checkList[x].pairVal > checkList[j].pairVal
                            );
                            Debug.Log(
                                "--0-->>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : "
                                    + checkList[x].pairVal
                            ...
                            //if(result.pairVal != 0) {
                            float m = Mathf.Max(checkList[x].pairVal, checkList[j].pairVal);
                            if (m >= maxVal)
                            {
                                maxVal = m;
                            }
                        ...
                        case 1:
                            result = checkList.Find(
                                item => checkList[x].H_Val_1 > checkList[j].H_Val_1
                            );
                            Debug.Log(
                                "--1-->>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : "
                                    + checkList[x].H_Val_1
                            ...
                            //if(result.H_Val_1 != 0) {
                            float m1 = Mathf.Max(checkList[x].H_Val_1, checkList[j].H_Val_1);
                            if (m1 >= maxVal)
                            {
                                maxVal = m1;
                            }
                        ...
                        case 2:
                            result = checkList.Find(
                                item => checkList[x].H_Val_2 > checkList[j].H_Val_2
                            );
                            Debug.Log(
                                "--2-->>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : "
                                    + checkList[x].H_Val_2
                            ...
                            //if(result.H_Val_2 != 0)
                            //{
                            float m2 = Mathf.Max(checkList[x].H_Val_2, checkList[j].H_Val_2);
                            if (m2 >= maxVal)
                            {
                                maxVal = m2;
                            }
                        ...
                        case 3:
                            result = checkList.Find(
                                item => checkList[x].H_Val_3 > checkList[j].H_Val_3
                            );
                            Debug.Log(
                                "--3-->>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> : "
                                    + checkList[x].H_Val_3
                            ...
                            //if(result.H_Val_3 != 0) {
                            float m3 = Mathf.Max(checkList[x].H_Val_3, checkList[j].H_Val_3);
                            if (m3 >= maxVal)
                            {
                                maxVal = m3;
                            }
