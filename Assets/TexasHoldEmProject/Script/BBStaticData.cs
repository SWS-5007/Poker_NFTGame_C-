...
*/
        ...
        public const string phaseMessageInfoMakeYourSmallBlindBet =
            "Please Make Your Small Blind Bet...";
        public const string phaseMessageInfoMakeYourBigBlindBet =
            "Please Make Your Big Blind Bet...";
 ...
 /// <param name="numberList">Number list.</param>
        ...
        {
            if (cameraDefaultValue == -1)
                cameraDefaultValue = Camera.main.orthographicSize;
